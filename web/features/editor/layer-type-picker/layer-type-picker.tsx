...
import { Hash, LineStyle } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="mt-5 space-y-2">
        {LAYER_PICKER_ITEMS.map(({ descriptionKey, icon: Icon, titleKey, type }) => (
          <button
            className={cn(
          ...
          >
            ...
            <span>
              ...
              <span className="mt-0.5 block text-sm leading-5 text-muted">{t(descriptionKey)}</span>
            </span>
          </button>
        ))}
      </div>
