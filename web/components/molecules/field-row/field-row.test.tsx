...
describe("FieldRow", () => {
  it("associates its label with a composed control and displays the unit", () => {
    render(<FieldRow htmlFor="radius" label="Radius" unit="mm"><input id="radius" type="number" /></FieldRow>);
  ...
  it("renders optional supporting copy and an accessible error", () => {
    render(<FieldRow description="Measured from the center." error="Must be greater than zero." label="Radius"><input aria-label="Radius" /></FieldRow>);
