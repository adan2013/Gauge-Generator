...
namespace Gauge_Generator
{
    ...
    class Rectangle_Item : Layer
    {
        ...
        public override void CloneCreator(Layer original, string name)
        {
            ...
            Rectangle_Item o = (Rectangle_Item)original;
        ...
        public override void DrawLayer(ref Canvas can, bool HQmode, int size)
        {
            ...
            if (_angle != 0) rect.RenderTransform = new MEDIA.RotateTransform(_angle, rect.Width / 2, rect.Height / 2);
